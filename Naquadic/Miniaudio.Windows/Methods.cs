...
namespace Naquadic.Miniaudio.Windows
{
    internal static unsafe partial class Methods
    {
        ...
        [DllImport("miniaudio.dll", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern ma_result ma_resource_manager_register_decoded_data_w(ma_resource_manager* pResourceManager, [NativeTypeName("const wchar_t *")] ushort* pName, [NativeTypeName("const void *")] void* pData, [NativeTypeName("ma_uint64")] ulong frameCount, [NativeTypeName("ma_format")] Naquadic.Common.Enums.Format format, [NativeTypeName("ma_uint32")] uint channels, [NativeTypeName("ma_uint32")] uint sampleRate);
        ...
        [DllImport("miniaudio.dll", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern ma_result ma_sound_init_from_file_w(ma_engine* pEngine, [NativeTypeName("const wchar_t *")] ushort* pFilePath, [NativeTypeName("ma_uint32")] uint flags, [NativeTypeName("ma_sound_group *")] ma_sound* pGroup, [NativeTypeName("ma_fence *")] Naquadic.Common.Structs.Fence* pDoneFence, ma_sound* pSound);
